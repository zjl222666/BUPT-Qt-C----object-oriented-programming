...
public:
    ...
    void retranslateUi(QWidget *commodityInfo)
    {
        ...
        label_2->setText(QCoreApplication::translate("commodityInfo", "\345\215\225\344\273\267(\345\205\203)", nullptr));
